...
import SkillsTechnologies from "@/components/skills-technologies";
  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 bg-[#25D366] hover:bg-[#20b858] text-white p-3 rounded-full shadow-lg transition transform hover:scale-110 z-50"
      >
